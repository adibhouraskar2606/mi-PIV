...
public class Pos13_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText("Engineers describe the energy of a flowing fluid in a pipe as head. Major and minor losses refer to the effect of viscosity on decreasing the energy(or head)of a flowing fluid in a pipe.This internal friction is described throughmajor losses(the loss of energy to the fluid contact with the insideof the pipe) and minor losses(the loss of energy due to bends, expansions, and contractions in the pipe). The sum of the major and minor losses isreferred to as total head loss:");
        t1.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        TextView t2 = (TextView)findViewById(R.id.pos13TextView2);
        t2.setText("Engineers use the head loss to understand how much energy a fluid needs to travel through a piping network.If there is too much head loss in a pipe system, the flow will not travel through theentire network.");
