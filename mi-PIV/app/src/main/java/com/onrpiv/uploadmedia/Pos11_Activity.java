...
public class Pos11_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t2.setText("Thus equation states that the sum of the flow energy (\uD835\uDC43\uD835\uDF0C), kinetic energy ((\uD835\uDC49^2)/2), and potential energy (\uD835\uDC54\uD835\uDC67) is constant along a streamline in steady, incompressible, inviscid flow.A common application of this is to pick two points along a streamline and estimate fluid properties using a known value.This is stated mathematically from points 1 and 2 as:");
        ...
        t6.setText("Where solving for the velocity yields:");
