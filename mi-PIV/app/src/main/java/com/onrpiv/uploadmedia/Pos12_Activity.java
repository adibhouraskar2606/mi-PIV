...
public class Pos12_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText("External and internal flows are a way to describe thefluid flow relative to an object of interest. If the fluid is flowing inside of the object of interest such as in a pipe, the flow is described as internal(below).Internal flow typically has symmetric velocity profiles.");
