...
public class Pos4_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText("Vorticity and Circulation are two mathematical ideas which engineers use to describe rotating of a fluid. Vorticity is a measure of the local rotation of a point in a fluid velocity field(the blue point below). An example is shown here");
        ...
        t5.setText("Circulation is the line integral of the fluid velocity arounda given closed curve. To visualize, imagine that circulation is the amount of a vectorfield that lies parallel to a given curve. An example is shown below:");
        t5.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        TextView t6 = (TextView) findViewById(R.id.pos4TextView6);
        t6.setText("Circulation is commonly denoted Γ. Mathematically, 2D circulation is described asthe line integral of the velocity field tangent to a closed curve:");
        t6.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        TextView t7 = (TextView)findViewById(R.id.pos4TextView7);
        t7.setText("Where dl is thedifferential length of the given curve. This may be thought of as if you go around a circle in the flow, how much of the fluid velocity aligns with the direction of the circle.");
