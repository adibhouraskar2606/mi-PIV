...
public class Pos5_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText("A fluid is defined as a substance which continually deforms under an applied shear stress or external force.A common phrasing of this is a substance which takes the shape of its container.There are several ways to classify fluids as well includingthe chemical phases of gas, liquid, and plasma. Fluids which have a linearviscous response to shear are referred to as Newtonian fluids. Fluids which are not Newtonian, are referred to as non-Newtonian fluids and includeare eithershear-thinning (e.g. toothpaste) orshear-thickening (e.g. cornstarch and water). This distinction is important as the fluid properties and observations are dependent on phases. For example, the viscosity of a liquid is inversely proportional to temperature, whereas the viscosity of a gas is positively relatedas shown in the following figure:");
        ...
        t3.setText("mI-PIV is limitedby the seeding and observation of flow fields. While mI-PIV labs can observe gases and fluidsin low velocity flows,plasmas and high velocity flows require more expensive seeding and observation laboratory set-ups.");
