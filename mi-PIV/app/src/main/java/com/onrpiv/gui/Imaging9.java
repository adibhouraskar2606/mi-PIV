...
public class Imaging9 extends LearnImagingDummy {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String html10 = "The aperture is a variably sized opening that the light passes through before reaching the sensors. The aperture allows more and less light to reach the sensors and is another way to adjust the brightness of the final image as shown below.";
