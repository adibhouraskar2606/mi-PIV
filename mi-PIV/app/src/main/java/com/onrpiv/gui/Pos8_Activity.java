...
public class Pos8_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t4.setText("mI-PIV provides the user with a velocity field rather than a velocity profile. To find the velocity profile, the user must hold one axis constant, and plot the velocity in the other direction. For example, find the profile above given a field of pipe flow.");
