...
public class Pos14_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String html3 = "<u><b>No-Slip Boundary</u></b>: This assumption states that the flow velocity along a boundary is zero (or the velocity of the boundary if the surface is moving). This allows engineers to find solutions to flow field by setting boundary conditions<br>";
